...
function TodoItem({ todo, onChangeIsActive }) {
  ...
  return (
    <div data-cy="todo-item" className="relative flex items-center gap-3 bg-white px-5 py-4 border rounded-lg shadow-lg" >
      <Switch 
      ...
      />
      <p data-cy="todo-item-title" className="text-lg font-bold">
        {todo.title}
      </p>
